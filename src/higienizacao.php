...
<html lang="pt-br">
  <head>
    <meta charset="UTF-8">
    <title>Exemplo de higienização 1</title>
  </head>
  <body>
<?php
  if (fHigienizaGet([
...
?>
  <p><a href="?">Voltar</a></p>
  <p>Você informou o id: <?=$_GET['id']?></p>
  <p>Você informou o nome: <?=$_GET['nome'] ?: 'Não, não informou :('?></p>
  <p>Você informou o nome, com XSS: <?=$_GET['nome_xss'] ?: 'Não, não informou :('?></p>
<?php else: ?>
    <ul>
      <li>
